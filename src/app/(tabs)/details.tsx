...
// 1. REPLACED lucide-react-native with expo/vector-icons
...
// 2. REPLACED react-native-svg with expo built-in SVG components
        ...
        <View style={styles.mainCard}>
          ...
          <View style={styles.infoSection}>
            ...
            <View style={styles.infoRow}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                {/* UPDATED: Info -> Ionicons */}
                <Ionicons name="information-circle-outline" size={14} color="#999" style={{ marginLeft: 4 }} />
              </View>
          ...
          <View style={styles.selectorContainer}>
            ...
            <View style={styles.counterBox}>
              {/* UPDATED: Minus -> Ionicons */}
              <TouchableOpacity onPress={() => setUnits(Math.max(400, units - 1))} style={styles.countBtn}>
                <Ionicons name="remove" size={20} color="black" />
              </TouchableOpacity>
              <View style={styles.unitDisplay}><Text style={styles.unitText}>{units}</Text></View>
              {/* UPDATED: Plus -> Ionicons */}
              <TouchableOpacity onPress={() => setUnits(units + 1)} style={styles.countBtn}>
